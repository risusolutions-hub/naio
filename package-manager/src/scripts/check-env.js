...
const checks = [
  ...
  ['FTP_CONCURRENCY', config.ftp.concurrency],
  ['FTP_DIR_CONCURRENCY', config.ftp.dirConcurrency],
  ['FTP_RETRY_ATTEMPTS', config.ftp.retryAttempts],
  ['FTP_SMALL_FILE_MAX', `${config.ftp.smallFileMaxBytes} bytes`],
